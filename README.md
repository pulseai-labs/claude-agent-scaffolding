...
├── architect-critic/                  # architect-critic plugin (v0.6.1)
├── claude-security-audit/             # security-audit plugin (v0.1.4)
├── ossify/                            # skeleton-first replacement lifecycle (v1.9.0)
