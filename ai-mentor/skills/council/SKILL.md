...
Do not run a peer-review round between personas (deferred to a future version). Full recommendation policy: `references/recommendation-policy.md` (relative to the plugin root).
